...
node {
  ...
  if (env.BRANCH_NAME == 'master') {
    ...
    feature_flags_env = feature_flags_env + ' --build-arg FEATURE_COMPARE_ALL=true --build-arg FEATURE_POP_UP=true --build-arg FEATURE_ALL_COMMITMENTS_MENU_ITEMS=true'
  }
